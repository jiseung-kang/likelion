...
// LRU 알고리즘
;['Jeju', 'Pangyo', 'Seoul', 'NewYork', 'LA', 'Seoul', 'LA']['Jeju'][('Jeju', 'Pangyo', 'Seoul', 'NewYork', 'LA', 'Seoul', 'LA')][('Jeju', 'Pangyo')][ //1회차 //2회차
	('Jeju', 'Pangyo', 'Seoul', 'NewYork', 'LA', 'Seoul', 'LA')
][('Jeju', 'Pangyo', 'Seoul')][('Jeju', 'Pangyo', 'Seoul', 'NewYork', 'LA', 'Seoul', 'LA')][('Pangyo', 'Seoul', 'NewYork')][('Jeju', 'Pangyo', 'Seoul', 'NewYork', 'LA', 'Seoul', 'LA')][ //3회차 //4회차
	('Seoul', 'NewYork', 'LA')
][('Jeju', 'Pangyo', 'Seoul', 'NewYork', 'LA', 'Seoul', 'LA')][('NewYork', 'LA', 'Seoul')][('Jeju', 'Pangyo', 'Seoul', 'NewYork', 'LA', 'Seoul', 'LA')][('NewYork', 'Seoul', 'LA')][ //5회차 //6회차 //7회차
	// hit - 1
	// miss - 5
