...
console.log(`구분자 : ${path.sep}`); // 구분자는 OS마다 다르기때문에 폴더나 파일 경로를 사용할 때 path, sep을 사용해주셔야 합니다.
...
console.log(path.join(__dirname, 'source')); // join 사용하기!
console.log(path.join(__dirname, 'app.js')); // join 사용하기!
// console.log(path.join(__dirname + '/node')); // 금지
